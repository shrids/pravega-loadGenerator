...
//    private SequenceValidator sequenceValidator = new SequenceValidator(false);
//    private boolean forgetful = false;
//    private long attentionSpanMinutes = TimeUnit.HOURS.toMinutes(12);
//    private LocalDateTime startTime = LocalDateTime.now();
//
//    private Semaphore readerSync = new Semaphore(1, true);
...
//    }
//
//    public PravegaReader withReaderSync(Semaphore syncOn, SequenceValidator validator) {
//        this.readerSync = syncOn;
//        this.sequenceValidator = validator;
//        return this;
//    }
//
//    public PravegaReader withReadTimeout(int timeout) {
